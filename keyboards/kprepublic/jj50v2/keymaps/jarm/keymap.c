...
#define SPC_MOU LT(_MOUSE, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |  FN  | Ctrl | GUI  | Alt  |Lower |Mouse |Space |Raise | Left | Down |  Up  |Right |
     * `-----------------------------------------------------------------------------------'
     */
     ...
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * |      | MUTE | VOL- | VOL+ |  F4  | PGUP | PGDN |   -  |   =  |   [  |   ]  |  \   |
     * |------+------+------+------+------+------|------+------+------+------+------+------|
     * |      | PLAY | PREV | NEXT | STOP |  F11 |  F12 |ISO # |ISO / |   .  |   /  |      |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |             |      | Ralt | Vol- | Vol+ | Mute |
     * `-----------------------------------------------------------------------------------'
     */
    [_RAISE] = LAYOUT_ortho_5x12(
      ...
      _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_F4,   KC_PGDN, KC_PGUP, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
      _______, KC_MPLY, KC_MPRV, KC_MNXT, KC_MSTP, KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, KC_DOT,  KC_SLSH, _______, \
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | LOCK | Reset|Clicky|AudMod|Qwerty| Pure |Blank | WHL_D| MS_U | WHL_U|      |  Del |
     * |------+------+------+------+------+-------------+------+------+------+------+------|
     * |      |Aud on|AudOff|Vk_Tog|      |AGnorm|AGswap| MS_L | MS_D | MS_R |      | ACL0 |
     * |------+------+------+------+------+------|------+------+------+------+------+------|
     * |      |Voice-|Voice+|Mus on|MusOff|MidiOn|MidOff|      |      |      |      | ACL1 |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |             |      |      |      |      | ACL2 |
     * `-----------------------------------------------------------------------------------'
     */
    [_ADJUST] = LAYOUT_ortho_5x12(
      ...
      _______, AU_ON,   AU_OFF,  VK_TOGG, _______, AG_NORM, AG_SWAP, KC_MS_L, KC_MS_D, KC_MS_R, _______, KC_ACL0, \
     ...
     * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |RGB_TO| WHL_U|Mclick| VLK  | HU_D | HU_I | LCTL | MS_U | WHL_U|      |  Del |
     * +------|------+------+------+------+-------------+------+------+------+------+------|
    ...
    [_MOUSE] = LAYOUT_ortho_5x12(
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  \
      _______, RGB_TOG, KC_WH_U, KC_BTN3, VK_TOGG, RGB_HUD, RGB_HUI, KC_LCTL, KC_MS_U, KC_WH_U, _______, KC_DEL,  \
